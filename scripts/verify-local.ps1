...
node --check js/services/subscription/paypal-checkout-service.js
node --check js/services/subscription/paypal-subscription-service.js
node --check js/services/subscription/paypal-subscription-flow.js
...
node --check supabase/functions/_shared/paypal-checkout-handler.js
node --check supabase/functions/_shared/paypal-webhook-handler.js
node --check supabase/functions/_shared/paypal-subscription-handler.js
node --check supabase/functions/_shared/lib/paypal-client.js
node --check supabase/functions/_shared/lib/paypal-plans.js
...
node --check js/services/shop/shop-ops-repository.js
node --check supabase/functions/_shared/shop-ops-handler.js
