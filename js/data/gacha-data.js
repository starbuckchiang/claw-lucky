  ...
  const mascots = [
    {
      ...
      image: './images/mascots/mascot-fox.jpg',
    ...
    },
    {
      ...
      image: './images/mascots/mascot-cat.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 50,
      tickets: 0,
      duplicateBonus: 20
    },
    {
      ...
      image: './images/mascots/mascot-penguin.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 55,
      tickets: 0,
      duplicateBonus: 20
    ...
    },
    {
      ...
      image: './images/mascots/mascot-deer.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 100,
      tickets: 1,
      duplicateBonus: 40
    },
    {
      ...
      image: './images/mascots/mascot-rabbit.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 120,
      tickets: 1,
      duplicateBonus: 40
...

    {
      ...
      image: './images/mascots/mascot-seal.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 180,
      tickets: 1,
      duplicateBonus: 80
    },
    {
      ...
      image: './images/mascots/mascot-dragon.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 220,
      tickets: 2,
      duplicateBonus: 80
...

    {
      ...
      image: './images/mascots/mascot-phoenix.jpg',
      silhouette: './images/mascots/mascot-shadow.png',
      points: 420,
      tickets: 3,
      duplicateBonus: 150
